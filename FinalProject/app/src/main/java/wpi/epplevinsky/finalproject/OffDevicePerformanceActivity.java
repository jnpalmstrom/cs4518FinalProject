...
public class OffDevicePerformanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off_device_performance);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.home_item) {
            ...
            startActivity(new Intent(OffDevicePerformanceActivity.this, MainActivity.class));
        }
        else if (item.getItemId() == R.id.on_device_performance_item) {
            // Go to Gallery Activity
            startActivity(new Intent(OffDevicePerformanceActivity.this, OnDevicePerformanceActivity.class));
        }
        else if (item.getItemId() == R.id.off_device_performance_item) {
            // Go to Gallery Activity
            startActivity(new Intent(OffDevicePerformanceActivity.this, OffDevicePerformanceActivity.class));
        }
    ...
    public void drawLineChart() {
        ...
        lineChartView = (LineChartView) findViewById(R.id.off_device_line_chart);

        List<PointValue> values = new ArrayList<>();

        Long highestLatency = Long.MIN_VALUE;

        SharedPreferences prefs = getSharedPreferences(MainActivity.OFF_SHARED_PREFS_FILE, MODE_PRIVATE);
